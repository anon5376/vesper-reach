...
- Ten vision reviews agreed the camera sat inside the kite, the mire was one green wash, the suit was a capsule, and the yard was a debug grid. The follow-up pulled the chase camera back, thinned the atmosphere rim, broke the ground into mud and ridge color, quieted the bloom, hid the suit panel in the yard, and put a bay wall around a faded grid. Frame work after that pass was about 12 ms.
